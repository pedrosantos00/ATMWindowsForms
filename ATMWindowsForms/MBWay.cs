...
{
    public partial class MBWay : Form
    {
        public User _user { get; set; }
        private readonly TransactionService _transactionService;
        private readonly UserService _userService;
        public MBWay(User user, UserService userService, TransactionService transactionService)
        {
            InitializeComponent();
        ...
        private void TransferBtn_Click(object sender, EventArgs e)
        {
            try
            {
                User? userToDeposit = _userService.GetByPhoneNumber(idToTransfer.Text);
